...
- **Aid station model**: each row stores name, distance, cutoff time, and runner arrival/check-in time. Runner times stay editable directly in the table for race-day check-ins; station metadata and removal live behind each row's Edit flow.
